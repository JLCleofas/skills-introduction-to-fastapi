...
def test_authenticate_user(test_user):
    ...
    print("test_user:", repr(test_user.username), type(test_user.username))
    print("auth_user:", repr(authenticated_user.username),
          type(authenticated_user.username))
...
@pytest.mark.asyncio
async def test_get_current_user_missing_payoad():
    encode = {'role': 'user'}
    token = jwt.encode(encode, SECRET_KEY, algorithm=ALGORITHM)
